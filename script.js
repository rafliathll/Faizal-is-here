...
// ===============================
//  DAMPAK KURANGNYA KUALITAS TIDUR  (DITAMBAHKAN)
// ===============================
const dampakKurangTidur = [
  "Tubuh menjadi lebih cepat lelah karena kurangnya waktu pemulihan otot.",
  "Kemampuan fokus dan koordinasi menurun sehingga risiko cedera meningkat.",
  "Produksi hormon penting seperti testosteron dan hormon pertumbuhan menurun.",
  "Daya tahan tubuh melemah dan performa latihan jauh dari maksimal.",
  "Pergerakan menjadi lambat dan tidak stabil saat latihan intens.",
  "Kualitas otot menurun karena proses regenerasi tidak berlangsung optimal.",
];

function tampilkanDampak() {
  const list = document.getElementById("dampakTidur");
  if (!list) return;

  list.innerHTML = "";
  dampakKurangTidur.forEach((dampak, i) => {
    setTimeout(() => {
